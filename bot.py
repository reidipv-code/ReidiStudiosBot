...
from core.tienda import init_tienda_db
...
from comandos.tienda import tienda, tienda_botones
...
COMANDOS_VALIDOS = [
    ...
    "/reclamarlogros", "/amigo", "/amigos", "/solicitudes", "/tienda"
]
...
def main() -> None:
    ...
    app.add_handler(CallbackQueryHandler(tienda_botones, pattern=r"^shop_"), group=10)
    ...
    app.add_handler(CommandHandler("tienda", tienda), group=10)
