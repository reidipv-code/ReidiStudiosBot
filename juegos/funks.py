...
async def terminar_funks(context, user_id, gano):
    # Sacamos la partida de memoria INMEDIATAMENTE para que ningún error
    # durante premios/misiones pueda dejar al usuario bloqueado.
    ...
    try:
        ...
        # Fallback: elimina la sesión directamente si SQLite falla aquí.
        try:
            conn = sqlite3.connect(DB_PATH)
    ...
    try:
        ...
        # La partida ya quedó cerrada aunque falle una misión, premio o estadística.
        texto = "⚠️ *Partida finalizada.*\nNo se pudo procesar una parte de las recompensas."
