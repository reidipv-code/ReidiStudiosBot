...
async def terminar_mates(context, user_id, gano):
    # Cerrar primero el estado en memoria evita el bloqueo permanente por excepciones.
    ...
    try:
        ...
        if gano:
            ...
            if stats[2] >= 15 and dar_logro(user_id, "matematico"):
                await avisar_logro(context, user_id, "matematico")
            if stats[8] + stats[9] >= 10 and dar_logro(user_id, "cerebrito"):
